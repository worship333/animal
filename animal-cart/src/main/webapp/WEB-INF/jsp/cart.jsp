...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/ego-logo.gif" title="返回流浪动物之家首页" alt="返回流浪动物之家首页"></a></div>
    <div class="language"><a href="javascript:void(0);" onclick="toEnCart()"></a></div>
	<div class="progress clearfix">
		<ul class="progress-1">
			<li class="step-1"><b></b>1.我的想要收养</li>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-goods">动物</div>
